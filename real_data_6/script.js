...
function preload() {                                                        //37.0902° N, 95.7129° W
  mapimg = loadImage('https://api.mapbox.com/styles/v1/mapbox/dark-v9/static/-95.7129,37,3.2,0,0/1024x512?access_token=pk.eyJ1Ijoic2hhcm9ueWV1bmtpbSIsImEiOiJjazluYXM1dGowMGQ2M2dxcnd6MzJ0MmVkIn0.LxQnR30wG7XeNoMOUFtVfw');
...
function setup() {
  ...
  var cy = mercY(clat);
    ...
    for (var i = 0; i < data.length; i = i + 1){
      ...
      var x = mercX(lon) - cx;
      var y = mercY(lat) - cy;
                    // (-, min, range scale max pix,\\\\\ scale, variation? )
      var d = map(cases, 0, 3000, 1, 3);
      fill(255, 0, 255, 200);
      ellipse(x, y, d, d);
    }
