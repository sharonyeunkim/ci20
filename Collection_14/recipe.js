...
fetch('new_new.json').then(function(response) {
...
function showRecipes() {
    var selectedRecipes = [];
  //   var duplicates = data.filter(function(item, index){
 ...
 //    var single = selectedTags.forEach(tag);
 //    var filtered = selectedTags.filter(function(single) {
 //    // Create an array using `.split()` method
 //    var tags = single.category.split(' ');
...
//
// $("#filter-paragraph").addClass("load");​
